...
def train_ext(args, data) :     
    ...
    score_df.to_csv(args.ext_result_path, index = False)
    pickle.dump(results, open(args.ext_result_path.with_suffix('.pkl'), 'wb'))
    print(score_df)